...
<!-- Mirrored from themesdesign.in/drixo/vertical/tables-datatable.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 10 Jan 2019 03:20:04 GMT -->
					...
					<ul>
						...
						<li>
							<a href="index.html" class="waves-effect">
								...
								<span>
									Dashboard <span class="badge badge-success badge-pill float-right">
									3</span>
								</span>
							</a>
						</li>
						...
						<li class="has_sub">
							...
							<ul class="list-unstyled">
								<li>
									<a href="icons-material.html">
									Material Design</a>
								</li>
								<li>
									<a href="icons-ion.html">
									Ion Icons</a>
								</li>
								<li>
		...
		<div class="content-page">
									...
									<div class="slimscroll" style="max-height: 230px;">
										...
										<a href="javascript:void(0);" class="dropdown-item notify-item">
											<div class="notify-icon">
												<img src="assets/images/users/user-2.jpg" alt="user-img" class="img-fluid rounded-circle">
											</div>
										...
										<a href="javascript:void(0);" class="dropdown-item notify-item">
											<div class="notify-icon">
												<img src="assets/images/users/user-3.jpg" alt="user-img" class="img-fluid rounded-circle">
											</div>
											<p class="notify-details">
												<b>
												Thomas J. Mimms</b>
										...
										<a href="javascript:void(0);" class="dropdown-item notify-item">
											<div class="notify-icon">
												<img src="assets/images/users/user-4.jpg" alt="user-img" class="img-fluid rounded-circle">
											</div>
											<p class="notify-details">
										...
										<a href="javascript:void(0);" class="dropdown-item notify-item">
											<div class="notify-icon">
												<img src="assets/images/users/user-5.jpg" alt="user-img" class="img-fluid rounded-circle">
											</div>
											<p class="notify-details">
												<b>
												Kendall E. Walker</b>
										...
										<a href="javascript:void(0);" class="dropdown-item notify-item">
											<div class="notify-icon">
												<img src="assets/images/users/user-6.jpg" alt="user-img" class="img-fluid rounded-circle">
											</div>
											<p class="notify-details">
												<b>
												David M. Ryan</b>
			...
			<footer class="footer">
				...
				<span class="d-none d-sm-inline-block">
					- Crafted with <i class="mdi mdi-heart text-danger">
					</i>
...
<!-- Mirrored from themesdesign.in/drixo/vertical/tables-datatable.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 10 Jan 2019 03:20:12 GMT -->
